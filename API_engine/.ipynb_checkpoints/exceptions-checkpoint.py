...
__all__ = (
    ...
    "AsinInfoNotFoundException", "AsinInfoAlreadyExistsException"
)
...
class AsinInfoAlreadyExistsException(AlreadyExistsException):
    """Error raised when a AsinInfo already exists"""
    message = "The Asin Info already exists"

class AsinInfoNotFoundException(NotFoundException):
    """Error raised when a AsinInfo does not exist"""
    message = "The Asin Info does not exist"
